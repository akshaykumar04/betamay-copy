...
(function(window, factory) {
    ...
    function iframe(iframeUrl, instance, queryParams, hashUrl) {
        ...
        return '<div class="lity-iframe-container"><iframe frameborder="0" allow="autoplay" allowfullscreen src="' + iframeUrl + '"/></div>';
    }
...
(function(a,b){// REMOVE IF DRUPAL
b.behaviors.test={attach:function attach(){function b(){e.hasClass("slick-initialized")||e.slick(f)}function c(){e.hasClass("slick-initialized")&&e.slick("unslick")}function d(a,b){b(a),a.addListener(b)}var e=a(".js-carousel"),f={arrows:!1,centerMode:!0,centerPadding:"10%",dots:!0,slidesToShow:1,touchThreshold:10};if(e.hasClass("leadership-grid")&&(f.slidesToShow=3,f.responsive=[{breakpoint:900,settings:{slidesToShow:2}},{breakpoint:550,settings:{slidesToShow:1}}]),b(),e.attr("data-target-width")){var g=e.attr("data-target-width"),h=window.matchMedia("(max-width:"+g+")");d(h,function(a){a.matches?b():c()})}}}})(jQuery,Drupal);
