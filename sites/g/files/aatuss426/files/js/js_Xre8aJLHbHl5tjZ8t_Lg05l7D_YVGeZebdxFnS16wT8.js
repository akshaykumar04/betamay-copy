...
a(".js-scroll").on("click",function(b){b.preventDefault();var c=a(".header").outerHeight(),d=a(this).attr("href");console.log(d),a("html, body").animate({scrollTop:a(d).first().offset().top-c},500)})})(jQuery,Drupal);
